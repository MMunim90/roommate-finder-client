...
const FindingCounter = () => {
  return (
    <div className="my-8">
      <h1 className="font-bold text-3xl lg:text-5xl my-10 text-center">Why You Need To Use Find Mate ?</h1>
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6 text-start text-black">
        <div className="bg-gray-300 p-12 rounded-2xl">
          <img
            ...
            alt=""
          />
          <h1 className="text-3xl my-4">Record!</h1>
          <CountUp
        ...
        <div className="bg-gray-300 p-12 rounded-2xl">
          <img
            ...
            alt=""
          />
          <h1 className="text-3xl my-4">Safety</h1>
          {" "}
        ...
        <div className="bg-gray-300 p-12 rounded-2xl">
          <img
            ...
            alt=""
          />
          <h1 className="text-3xl my-4">We're the busiest</h1>
          <CountUp
            className="font-extrabold text-5xl"
            end={5}
            duration={10}
