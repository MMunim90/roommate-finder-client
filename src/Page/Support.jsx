  ...
  return (
    <div className="max-w-4xl mx-auto p-6 my-10 bg-gray-400 rounded-lg shadow-md">
      ...
      <p className="leading-relaxed">
        Need help? We're here for you! If you have questions or face issues using Find Mate,
        feel free to reach out through our contact form or email us at 
        <a href="mailto:support@findmate.com" className="underline ml-1">support@findmate.com</a>.
