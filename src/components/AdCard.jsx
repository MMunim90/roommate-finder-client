...
const AdCard = ({ ad }) => {
  ...
  return (
    <div className="max-w-md rounded-2xl shadow-lg bg-white overflow-hidden hover:shadow-xl transition-shadow duration-300 border-2">
      <img className="w-full h-56 object-cover" src={photo} alt='' />
